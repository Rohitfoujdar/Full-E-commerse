...
export default function Navbar() {
  ...
  return (
    <>
      <div className={`max-w-screen-2xl container my-0 mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 dark:bg-slate-900 dark:text-white ${
          Scrolled ?"stick-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out":"" }`}>
        <div className="navbar h-16 bg-base-80">
